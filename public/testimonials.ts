const Testimonials: Testimonial[] = [
  ...
  {
    body:
      'Just checked script kit out and it is freaking amazing!!! Thank you.',
  ...
  {
    body:
      'We are using ScriptKit to quickly automate tedious processes in our production pipeline and it’s awesome.',
  ...
  {
    body:
      'Enjoying the updated design for ScriptKit by @johnlindquist. The fact that it is just JS scripts at the end of the day really motivating for automating frequent workflows',
